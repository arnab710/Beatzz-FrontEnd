...
export default function StarPostRating({ maxRating = 5, color = "rgba(14, 183, 183, 0.749)", size = 50, className = "", messages = [], defaultRating = 0, onSetRating, resetRating }) {
